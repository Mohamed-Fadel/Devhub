...
// in devhub/test/unit/infrastructure/network/interceptors/log_interceptor_test.dart.
...
import 'package:dio/src/dio_exception.dart' as _i5;
...
class _FakeStackTrace_4 extends _i1.SmartFake implements StackTrace {
  _FakeStackTrace_4(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeDioException_5 extends _i1.SmartFake implements _i5.DioException {
  _FakeDioException_5(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockResponseInterceptorHandler extends _i1.Mock
  ...
  @override
  void next(_i7.Response<dynamic>? response) => super.noSuchMethod(
...
class MockResponse<T> extends _i1.Mock implements _i7.Response<T> {
  ...
  Uri get realUri =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeUri_1(this, Invocation.getter(#realUri)),
          )
          as Uri);
}
